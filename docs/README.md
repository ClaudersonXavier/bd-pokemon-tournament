...
> 📘 **Documentação detalhada:** [Ver Esquema do BD completo](esquema-bd.md)
...
|--------------|--------------------------------------------------|---------------------------------------------------|
| `treinador`  | Treinadores cadastrados no sistema              | 🔗 [Ver especificação](dicionario-de-dados.md#tabela-treinador) |
| `pokemon`    | Instâncias de Pokémon (pertencentes a treinadores) | 🔗 [Ver especificação](dicionario-de-dados.md#tabela-pokemon) |
| `especie`    | Espécies de Pokémon (Pikachu, Charizard, etc.)  | 🔗 [Ver especificação](dicionario-de-dados.md#tabela-especie) |
| `ataque`     | Movimentos/ataques disponíveis                   | 🔗 [Ver especificação](dicionario-de-dados.md#tabela-ataque) |
| `tipo`       | Tipos elementais (Fire, Water, Grass, etc.)      | 🔗 [Ver especificação](dicionario-de-dados.md#tabela-tipo) |
| `time`       | Equipes montadas para competição                | 🔗 [Ver especificação](dicionario-de-dados.md#tabela-time) |
| `torneio`    | Competições organizadas                          | 🔗 [Ver especificação](dicionario-de-dados.md#tabela-torneio) |
| `batalha`    | Confrontos entre times                           | 🔗 [Ver especificação](dicionario-de-dados.md#tabela-batalha) |
...
> 📘 **Documentação completa:** [Dicionário de Dados](dicionario-de-dados.md) | [Esquema do BD](esquema-bd.md)
...
> 📊 **Ver exemplos de uso:** [Views SQL](views-sql.md)
...
> 📘 **Documentação completa:** [Povoamento e Seeders](povoamento-seeders.md)
...
> 📘 **Detalhes técnicos:** [Ver documentação completa de seeders](povoamento-seeders.md)
...
> 📘 **Ver mais informações:** [Povoamento e Seeders](povoamento-seeders.md#️-configurações-avançadas)
</details>
